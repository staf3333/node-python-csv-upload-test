...
# Set initial Directory here and
data_directory_start = "C:/Users/shabamus/OneDrive - adidas/Documents/Basketball/Strung Basketball/Instron Testing 6_27_2023/Strung BBall/Everyday_Run_Testing"
...
#     print(names[n-1])
    ...
    plt.plot(Extension, Load, label=names[n-1])
    plt.legend()
